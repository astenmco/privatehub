...
<html lang="en">
  ...
  <body>
    ...
    <div class="container-lg">
        ...
        <!-- RESPOSITORY INFOS -->
        <?php include '../../../src/php/content/current_repository.php'; ?>

        <hr>

        <!-- FILTER TAG RESULTS  -->
        <?php include '../../../src/php/content/filter_tag_results.php'; ?>

        <!-- TAG RESULTS -->
        <?php include '../../../src/php/content/tag_results.php'; ?>
    ...
    <script>
      ...
      $('.delete_tag_button').click(function(){return confirm("Confirm the tag suppression?");});
